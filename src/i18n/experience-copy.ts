...
const en: ExperienceCopy = {
  ...
  daily: 'Daily', dailyDetail: 'One official word for everyone. Daily will arrive in a later update.',
  dailyUnavailableTitle: 'Daily is coming later.',
  dailyUnavailableDetail: 'The same official word will be available to everyone in each language. Until then, Practice and Play Avi are ready offline.',
...
const es: ExperienceCopy = {
  ...
  daily: 'Diario', dailyDetail: 'Una palabra oficial para todos. El reto diario llegará en una actualización posterior.',
  dailyUnavailableTitle: 'El reto diario llegará más adelante.',
  dailyUnavailableDetail: 'Todos jugarán con la misma palabra oficial en cada idioma. Mientras tanto, Práctica y Jugar con Avi funcionan sin conexión.',
...
const translations: Record<InterfaceLocale, ExperienceCopy> = {
  ...
  ca: {
    ...
    daily: 'Diari', dailyDetail: 'Una paraula oficial per a tothom. El repte diari arribarà en una actualització posterior.',
    dailyUnavailableTitle: 'El repte diari arribarà més endavant.',
    dailyUnavailableDetail: 'Tothom jugarà amb la mateixa paraula oficial en cada idioma. Mentrestant, Pràctica i Jugar amb l’Avi funcionen sense connexió.',
  ...
  fr: {
    ...
    daily: 'Quotidien', dailyDetail: 'Un mot officiel pour tout le monde. Le défi quotidien arrivera dans une prochaine mise à jour.',
    dailyUnavailableTitle: 'Le défi quotidien arrivera plus tard.',
    dailyUnavailableDetail: 'Tout le monde jouera avec le même mot officiel dans chaque langue. En attendant, Entraînement et Jouer contre Avi fonctionnent hors ligne.',
  ...
  de: {
    ...
    daily: 'Täglich', dailyDetail: 'Ein offizielles Wort für alle. Die tägliche Herausforderung folgt in einem späteren Update.',
    dailyUnavailableTitle: 'Die tägliche Herausforderung kommt später.',
    dailyUnavailableDetail: 'Alle spielen in jeder Sprache mit demselben offiziellen Wort. Bis dahin funktionieren Training und Gegen Avi offline.',
